...
-- ⚠️ 결과는 매수 권유 아님.
--
-- NOTE: per IS NOT NULL 요구를 제거 — KR 은 PER 누락 빈번(KRX 로그인 필요).
--   대신 valuation_score 로 과대평가를 거른다. dividend_yield 는 fraction(0.04=4%).
...
WHERE market = 'KR'
  ...
  AND valuation_score >= 40            -- 극단적 고평가 제외 (PER 대체)
